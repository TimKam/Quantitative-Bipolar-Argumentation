...
def test_general_robust_inferences ():

   assert ( check_general_robust_inferences ( QBAF_0, [ QBAF_1, QBAF_0, QBAF_2 ], 'a', 'b') == True )
   assert ( check_general_robust_inferences ( QBAF_0, [ QBAF_1, QBAF_0, QBAF_2, QBAF_3 ], 'a', 'b') == False )


def test_expansion_based_robust_inferences ():

   assert ( check_expansion_based_robust_inferences ( QBAF_2, QBAF_1, 'a', 'b' ) == True )
   assert ( check_expansion_based_robust_inferences ( QBAF_2, QBAF_0, 'a', 'b' ) == False )


def test_strength_update_based_robust_inferences ():

   assert ( check_update_based_robust_inferences ( QBAF_0, [ 'c', 'd', 'e' ] , 0.03, 'a', 'b' ) == True )
   assert ( check_update_based_robust_inferences ( QBAF_1, [ 'h', 'g' ] , 0.03, 'a', 'b' ) == True )