...
/**
 * @brief Return a list of a set of arguments that are minimal (all have the same size) SSI Explanations
 * of arg1 and arg2 w.r.t. QBAFramework self (QBF') and QBAFramework other (QBF), NULL if an error was encountered.
 * 
 * @param self an instance of QBAFramework
 * @param other a different instance of QBAFramework
...
_QBAFramework_minimal_SSIExplanations(QBAFrameworkObject *self, QBAFrameworkObject *other, PyObject *arg1, PyObject *arg2)
{
    ...
    // Find SSI Explanations with trying with size from 1 to length of candidate_arguments
    Py_ssize_t max_size = PySet_GET_SIZE(candidate_arguments);
    PyObject *subsets, *explanations, *set;
    ...
    // At least one explanation should be found
    PyErr_SetString(PyExc_RuntimeError,
                        "Unexpected error: No SSI Explanation found");
    return NULL;
}
